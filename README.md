...
- **[Firefox](https://www.firefox.com/en-US/)** – My default browser.
- **[Zen-Browser](https://zen-browser.app/)** – Lightweight and privacy-focused.

---

### 💻 Visual Studio Code

[Visual Studio Code](https://code.visualstudio.com/) is Microsoft’s editor, telemetry included, but still my go-to if privacy isn’t a huge concern.
...
Warehouse gives you a simple interface to manage complex Flatpak settings — all without touching the command line.
